...
import { isSameDay, startOfToday, isWithinInterval, startOfDay, endOfDay, differenceInCalendarDays, eachDayOfInterval, isWeekend } from 'date-fns';
...
export default function CalendarPage() {
    ...
    // Example holiday (holidays don't count as vacation days)
    const [holidays] = useState<Feature[]>([
        {
            id: 'holiday-1',
            name: 'Christmas Day',
            startAt: new Date(new Date().getFullYear(), 11, 25, 0, 0, 0),
            endAt: new Date(new Date().getFullYear(), 11, 25, 23, 59, 59),
            status: {
                id: 'holiday',
                name: 'Holiday',
                color: '#f59e0b', // Orange
